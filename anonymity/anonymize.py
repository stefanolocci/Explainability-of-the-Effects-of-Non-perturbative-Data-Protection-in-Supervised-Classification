...
# "mondrian" and "mondrian_ldiv" refers to the "basic_mondrian" that is the one which uses generaliz. hierarchies
# "classic_mondrian" refers to the first implementation of the algorithm where there are no gen. hierarchies but,
#     which imposes an intuitive ordering on each attribute and there are no categorical attributes.
...
class Anonymizer:
    def __init__(self, args):
        ...
        # folder for all anonymized_data
